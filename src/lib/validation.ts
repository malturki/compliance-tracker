...
export const createObligationSchema = z.object({
  ...
  frequency: z.enum(['annual', 'semi-annual', 'quarterly', 'bi-monthly', 'monthly', 'weekly', 'one-time', 'event-triggered']),
...
export const updateObligationSchema = z.object({
  ...
  frequency: z.enum(['annual', 'semi-annual', 'quarterly', 'bi-monthly', 'monthly', 'weekly', 'one-time', 'event-triggered']).optional(),
