...
export interface TemplateObligation {
  ...
  riskLevel: RiskLevel
  alertDays: number[]
  /** External party the obligation is owed to (e.g. "IRS", "Delaware Division of Corporations"). Leave undefined for internal obligations. */
  counterparty?: string
  jurisdiction?: string
  amount?: number
  autoRecur: boolean
    ...
    obligations: [
      {
        ...
        amount: 450,
        alertDays: [30, 14, 7, 1],
        counterparty: 'Delaware Division of Corporations',
      ...
      },
      {
        ...
        amount: 299,
        alertDays: [30, 14],
        counterparty: 'Republic Registered Agent LLC',
        jurisdiction: 'Delaware',
        autoRecur: true,
  ...
  },
  {
    ...
    obligations: [
      ...
      },
      {
        ...
        amount: 800,
        alertDays: [60, 30, 14],
        counterparty: 'California Secretary of State',
      ...
      },
      {
        ...
        amount: 300,
        alertDays: [90, 60, 30],
        counterparty: 'New York Department of State',
      ...
      },
      {
        ...
        amount: 0,
        alertDays: [60, 30, 14],
        counterparty: 'Texas Secretary of State',
        jurisdiction: 'Texas',
        autoRecur: true,
      ...
      },
      {
        ...
        amount: 200,
        alertDays: [60, 30, 14],
        counterparty: 'Illinois Secretary of State',
      ...
      },
      {
        ...
        amount: 125,
        alertDays: [60, 30, 14],
        counterparty: 'Massachusetts Secretary of the Commonwealth',
